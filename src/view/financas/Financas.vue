...
export default {
  ...
  data: function () {
    return {
      ...
      responses: [],
      responses2: [
        { answer2: 'Sim', questionId: 4 },
        { answer2: 'Nao', questionId: 5 },
        { answer2: 'talvez', questionId: 6 },
      ],
      responses3: [
        { answer3: 'Sim', questionId: 7 },
        { answer3: 'Não', questionId: 8 },
        { answer3: 'talvez', questionId: 9 },
      ],
      responses4: [
        { answer4: 'Sim', questionId: 10 },
        { answer4: 'Não', questionId: 11 },
        { answer4: 'talvez', questionId: 12 },
      ],
      responses5: [
        { answer5: 'Sim', questionId: 13 },
        { answer5: 'Não', questionId: 14 },
        { answer5: 'talvez', questionId: 15 },
      ],
      fields: [
        { key: 'id', label: '#' },
        {
  ...
  methods: {
    ...
    save() {
      ...
      request()
        .post(
          `http://localhost:3000/answer/${companyId}`,
