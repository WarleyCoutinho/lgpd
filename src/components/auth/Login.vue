      ...
      <b-div v-if="showSignup">
        ...
        <b-row>
          ...
          <b-col md="6" sm="12">
            ...
            />
            <b-form-invalid-feedback id="cnpj">{{
              veeErrors.first('cnpj')
            }}</b-form-invalid-feedback>
          </b-col>
        </b-row>
        <b-row>
          <b-col md="3" sm="12">
            ...
            />
            <b-form-invalid-feedback id="street">{{
              veeErrors.first('street')
            }}</b-form-invalid-feedback>
          </b-col>
          <b-col md="3" sm="12">
            ...
            />
            <b-form-invalid-feedback id="zipCode">{{
          ...
          <b-row>
            ...
            <b-row>
              <div class="buttons-login">
                Já tem cadastro?
                <a
                  class="buttons-login03"
                  href
                  @click.prevent="showSignup = !showSignup"
                >
                  <span v-if="showSignup" class="buttons-login02"
                    >Acesse o Login!</span
                  >
                </a>
              </div>
            </b-row>
            <b-button class="buttons-cancelar" v-if="showSignup" @click="reset">
              Cancelar
            </b-button>
            <b-button variant="info" class="buttons-limpar" @click="resetForm()"
              >Limpar</b-button
            >
          </b-row>
        </b-col>
